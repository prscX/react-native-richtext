...
//  Pods
//
//  Created by Pranav Chauhan on 20/06/20.
//
...
@objc public class EditorDemoController: UIViewController {
...
extension EditorDemoController : Aztec.FormatBarDelegate {
    ...
    public func formatBar(_ formatBar: FormatBar, didChangeOverflowState state: FormatBarOverflowState) {
        switch state {
        case .hidden:
