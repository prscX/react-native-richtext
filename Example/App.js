...
const ORDERED_REVERSED =
  ...
  '    <li>One</li>\n' +
  '</ol>';
const ORDERED_REVERSED_WITH_START =
  ...
  '    <li>Eight</li>\n' +
  '</ol>';
const ORDERED_REVERSED_NEGATIVE_WITH_START =
  '<h4>Reversed Start in 1 List:</h4>' +
  '<ol reversed start="1">\n' +
  '    <li>One</li>\n' +
  '    <li>Zero</li>\n' +
  '    <li>Minus One</li>\n' +
  '</ol>';
const ORDERED_REVERSED_WITH_START_IDENT =
  '<h4>Reversed Start in 6 List:</h4>' +
  '<ol reversed>' +
  '   <li>Six</li>' +
  '   <li>Five</li>' +
  '   <li>Four</li>' +
...
const VIDEOPRESS_2 =
  '[wpvideo OcobLTqC w=640 h=400 autoplay=true html5only=true3]';
